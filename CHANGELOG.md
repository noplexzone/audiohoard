...
- Bound startup orphan pruning to small committed batches with real writer handoff windows so valid logins are not starved by large terminal-history cleanup.
